function getCalendarData(data){
  ...
  $('#calendar').fullCalendar({
    ...
    eventClick:  function(event, jsEvent, view) {
      ...
      $('#bookedClientTotal').html("<strong>Cliente </strong> [" + event.bookedClients.length + "/" + event.maxClientPerBooking + "]");
  ...
  $('#submitButtonEdit').on('click', function(e){
    ...
    $('#editForm').attr('action', '/center/client-classes/edit/' + idValueEdit + '?_method=put');
    $('#editForm').submit();
  });
  ...
  $('#submitButtonBooking').on('click', function(e){
    ...
    $('#bookForm').attr('action', '/center/client-classes/booking/' + idValueEdit);
    $('#bookForm').submit();
  });
